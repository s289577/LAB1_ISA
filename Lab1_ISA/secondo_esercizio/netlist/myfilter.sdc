...
# Created by write_sdc on Mon Oct 25 20:48:29 2021
...
create_clock [get_ports CLK]  -name MY_CLK  -period 7.32  -waveform {0 3.66}
set_clock_uncertainty 0.07  [get_clocks MY_CLK]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports RST_N]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports VIN1]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports VIN2]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports VIN3]
...
set_output_delay -clock MY_CLK  -max 0.5  [get_ports VOUT1]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports VOUT2]
set_output_delay -clock MY_CLK  -max 0.5  [get_ports VOUT3]
